...
\usepackage{fancyvrb}
\usepackage{amsmath}
\usepackage[style=authoryear, backend=biber]{biblatex}  % citations + references (run biber)
...
\def\smudivh{2.5pt}   % thickness of the divider progress line
\AtBeginSection[]{%
  \begin{frame}[c]
    \centering
    \begin{minipage}{0.8\textwidth}
      ...
      \vspace{0.6em}
      \pgfmathsetlength{\smuprog}%
        {\linewidth*min(\insertsectionnumber-1,\totalsections)/\totalsections}%
      \begin{tikzpicture}
